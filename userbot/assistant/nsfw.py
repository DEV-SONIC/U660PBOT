...
@Sonic.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_true")))
...
@Sonic.tgbot.on(CallbackQuery(data=re.compile(r"^age_verification_false")))
...
@Sonic.tgbot.on(CallbackQuery(data=re.compile(r"^chg_of_decision_")))
