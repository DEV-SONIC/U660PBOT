...
roz ="**[ . 𝐒𝐎𝐔𝐑𝐂𝐄 𝐒𝐎𝐍𝐈𝐂 ᭡ .](t.me/U660P)\n✦┅━╍━╍╍━━╍━━╍━┅✦**\n\n**- مرحبا بك عزيز المستخدم هذه هي قائمة اوامر السورس **\n\n`.م1` ◂ اوامر الأدمن\n`.م2` ◂ اوامر المجموعة\n`.م3` ◂ اوامر الترحيب\n`.م4` ◂ اوامر الردود\n`.م5` ◂ اوامر الترفيه\n`.م6` ◂ اوامر حماية الخاص\n`.م7` ◂ اوامر الكشف \n`.م8` ◂ اوامر الروابط \n`.م9` ◂ اوامر المنع\n`.م10` ◂ اوامر الحماية\n`.م11` ◂ اوامر التحميل\n`.م12` ◂ اوامر التكرار\n`.م13` ◂ اوامر الانتحال\n`.م14` ◂ اوامر التقليد\n`.م15` ◂ اوامر الترجمة\n`.م16` ◂ اوامر التنظيف\n`.م17` ◂ اوامر الوقتي\n`.م18` ◂ جلب الذاتية والاضافة\n`.م19` ◂ اوامر الاذاعة\n`.م20` ◂ اوامر التمبلر\n`.م21` ◂ اوامر التسلية\n `.م22` ◂ اوامر التحويل الصيغ\n `.م23` ◂ اوامر الملصقات\n `.م24` ◂ اوامر الميديا"
@Sonic.on(admin_cmd(pattern="الاوامر"))
@Sonic.on(sudo_cmd(pattern="الاوامر", allow_sudo=True))
async def cmds(Sonic):
    await edit_or_reply(Sonic, roz)
...
@Sonic.on(events.NewMessage(pattern=r"\.(.*)", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@Sonic.on(admin_cmd("م4"))
@Sonic.on(sudo_cmd("م4", allow_sudo=True))
async def _(Sonic):
    await edit_or_reply(Sonic, "**قائـمه اوامر الردود**\n\n ◂ `.اضف رد` + ردك\n- لوضع رد معين في المجموعة اكتب الامر وردك\n\n ◂ `.حذف الردود`\n- فقـط ارسل الامر في المجموعة لحذف الردود المضافة\n\n ◂ `.الردود`\n- ارسل الامر في المجموعه لعرض ردود المجموعه")
